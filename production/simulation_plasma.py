...
np.savetxt('../results/Plasma/parameters_plasma.txt', parameter)

laser = laser.laser(L, N, Lz, Nz, k, K, 'Plasma', nb_save = nb_save)
laser.initialize(gauss)
laser.propagation()

with open('../results/Plasma/intensity_plasma.txt', 'wb') as outfile:
